...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(ValidarExpresion()){
            ...
            JOptionPane.showMessageDialog(null, "Error, formula no esta escrita correctamente");
        }
    ...
    /*
    Creamos metodo para validad la expresion
    */
    public boolean ValidarExpresion(){
        Pila  pila = new Pila();//Para comunicar la interfaz con la clase Pila
    
        String cadena =  txt_expresion.getText();//Para recuperar el texto q el user haya inngresado
        
        for (int i = 0; i < cadena.length(); i++) {
            
            if(cadena.charAt(i) == '(' ||cadena.charAt(i) == '[' || cadena.charAt(i) == '{' ){
                pila.Insertar(cadena.charAt(i)); //si es verdad q lo inserte dentro de pila insertar 
            }else{
